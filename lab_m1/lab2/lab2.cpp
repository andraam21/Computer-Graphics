...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1.5f, 1, 3), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1, 1), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 3, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-2.2f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tethra"], shaders["VertexColor"], glm::vec3(-1.5f, 1.5f, 0), glm::vec3(0.75f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.5f, 1.5f, 0), glm::vec3(0.75f));
